...
// 获得符合要求的城市数据
func (ctl *PositionController) positionList(query map[string]interface{}, exclude map[string]interface{}, condMap map[string]map[string]interface{}, fields []string, sortby []string, order []string, offset int64, limit int64) (map[string]interface{}, error) {

	var positions []md.Position
	paginator, positions, err := md.GetAllPosition(query, exclude, condMap, fields, sortby, order, offset, limit)
