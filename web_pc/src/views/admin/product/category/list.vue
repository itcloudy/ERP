<template>
    <div>
        <el-breadcrumb separator="/">
            ...
            <el-breadcrumb-item :to="{ path: '/admin/product/category' }">类别</el-breadcrumb-item>
        </el-breadcrumb>
...
<script>
    ...
    methods:{
        ...
        goProductCategoryDetail(row, event){
            this.$router.push("/admin/product/category/detail/"+row.ID);
        },
        changeCreateForm(){
            this.$router.push("/admin/product/category/form/new");
        }
