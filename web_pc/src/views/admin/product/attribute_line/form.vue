...
<script>
    ...
    export default {
        ...
        methods:{
                        ...
                        if (this.lineForm.ID >0){
                            this.$ajax.put(SERVER_PRODUCT_ATTRIBUTE_LINE+this.lineForm.ID,this.lineForm).then(response=>{
                                ...
                                if(code=='success'){
                                    ...
                                    this.$router.push("/admin/product/attribute/line/detail/"+lineID);
                                }else{
            ...
            changeView(type,id){
                if ("list"==type){
                    this.$router.push("/admin/product/attribute/line");
                }else if ("form"==type){
                    this.$router.push("/admin/product/attribute/line/form/"+id);
                }
            },
        },
        created:function(){
