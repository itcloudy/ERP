<template>
    <div>
        <el-breadcrumb separator="/">
            ...
            <el-breadcrumb-item :to="{ path: '/admin/sale' }">销售管理</el-breadcrumb-item>
            <el-breadcrumb-item :to="{ path: '/admin/sale/order' }">销售订单</el-breadcrumb-item>
        </el-breadcrumb>
...
<script>
    ...
    methods:{
        ...
        goOrderDetail(row, event){
            this.$router.push("/admin/sale/order/detail/"+row.ID);
        },
        changeCreateForm(){
            this.$router.push("/admin/sale/order/form/new");
        }
