        ...
        <div class="left-main">
            <el-row class="tac">
                <el-col :span="24">
                    ...
                    -->
                    <el-menu theme="dark" :router="true"  v-for="(menu,index) in menuList" :key="index">
                        ...
                        <el-menu-item  v-if="!menu.children" :class="menu.Icon" :index="menu.path"><i :class="menu.Icon"></i>{{menu.name}}</el-menu-item>
                    </el-menu>
                </el-col>
            </el-row>
        </div>
