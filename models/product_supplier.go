...
// no records exist
func GetAllProductSupplier(query map[string]string, fields []string, sortby []string, order []string,
	offset int64, limit int64) (utils.Paginator, []ProductSupplier, error) {
	var (
...
// UpdateProductSupplier updates ProductSupplier by Id and returns error if
