...
func GetPurchaseOrderLineStateByID(id int64) (obj *PurchaseOrderLineState, err error) {
	o := orm.NewOrm()
	obj = &PurchaseOrderLineState{ID: id}
...
// no records exist
func GetAllPurchaseOrderLineState(query map[string]interface{}, exclude map[string]interface{}, condMap map[string]map[string]interface{}, fields []string, sortby []string, order []string, offset int64, limit int64) (utils.Paginator, []PurchaseOrderLineState, error) {
	var (
...
func UpdatePurchaseOrderLineStateByID(m *PurchaseOrderLineState) (err error) {
	o := orm.NewOrm()
	v := PurchaseOrderLineState{ID: m.ID}
...
func DeletePurchaseOrderLineState(id int64) (err error) {
	o := orm.NewOrm()
	v := PurchaseOrderLineState{ID: id}
	// ascertain id exists in the database
	if err = o.Read(&v); err == nil {
		var num int64
		if num, err = o.Delete(&PurchaseOrderLineState{ID: id}); err == nil {
